...
<section class="financial">
	<div class="container">
		<div class="team__title">
			...
			<h2 class="title"><?= $title_financial; ?></h2>
		</div>
		<h3 class="financial__location"><?= $text_location; ?></h3>
		...
		<div class="financial__slider">
			<?php foreach ( $groups_slider as $group_slider ) : ?>
				...
				$year = $group_slider['number_year'];
				?>
				<div class="financial__item">
					<div class="financial__item--count">
						<div class="count-gray"><?= $gray; ?></div>
						<div class="count-blue"><?= $blue; ?></div>
					</div>
	...
	<div class="financial__banner">
		...
		?>
			...
			<h3 class="text-banner"><?= $text_banner; ?></h3>
		</div>
</section>
